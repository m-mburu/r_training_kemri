...
- Generally we will be borrowing some ides from computer science/computation 
...
- Declarative knowledge is composed of statements of facts y is the square root of x if Y*y = x. Doesn't tell you how to find the quare root. All get  all participants < 6 months at adm who came for follow up 
...
- Algorithms have instructions and flow of control (copy the handout)
- Eg in our example read admission data filter kids less than 6 months read follow up data then join the two data sets
...
## Reasons 
- Crash When you /Throw the red error
